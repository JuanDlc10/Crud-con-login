<?php
    ...
    $conexion = conexion();
    $id = $_GET['id'];
    $sql = "SELECT * FROM t_evento WHERE id_evento = '$id'";
                ...
                <div class="col-12 col-sm-7 col-md-6 m-auto">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            ...
                            <input type="text" hidden name="id" value="<?php echo $item['id_evento'];?>">
                                ...
                                <div class="text-center mt-3">
                                    ...
                                    <a href="./inicio.php" class="btn btn-outline-primary">Inicio</a>
                                </div>
                            </form>
                        </div>
                    </div>
